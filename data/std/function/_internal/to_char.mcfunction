...
data modify storage std:vm r4 set value {left: "", right: ""}
$data modify storage std:vm r4.left set from storage std:vm str_pool[$(string)]

# Python脚本生成的代码
data modify storage std:vm r4.right set value "\\t"
function std:_internal/equals_const with storage std:vm r4
...
data modify storage std:vm r4.right set value "\\x0b"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 11

data modify storage std:vm r4.right set value "\\x0c"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 12

data modify storage std:vm r4.right set value "\\r"
function std:_internal/equals_const with storage std:vm r4
...
data modify storage std:vm r4.right set value "0"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 48

data modify storage std:vm r4.right set value "1"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 49

data modify storage std:vm r4.right set value "2"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 50

data modify storage std:vm r4.right set value "3"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 51

data modify storage std:vm r4.right set value "4"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 52

data modify storage std:vm r4.right set value "5"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 53

data modify storage std:vm r4.right set value "6"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 54

data modify storage std:vm r4.right set value "7"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 55

data modify storage std:vm r4.right set value "8"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 56

data modify storage std:vm r4.right set value "9"
function std:_internal/equals_const with storage std:vm r4
...
data modify storage std:vm r4.right set value "S"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 83

data modify storage std:vm r4.right set value "T"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 84

data modify storage std:vm r4.right set value "U"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 85

data modify storage std:vm r4.right set value "V"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 86

data modify storage std:vm r4.right set value "W"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 87

data modify storage std:vm r4.right set value "X"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 88

data modify storage std:vm r4.right set value "Y"
function std:_internal/equals_const with storage std:vm r4
execute if score rax vm_regs matches 1 run return 89

data modify storage std:vm r4.right set value "Z"
function std:_internal/equals_const with storage std:vm r4
...
data modify storage std:vm r4.right set value "_"
function std:_internal/equals_const with storage std:vm r4
