...
- [picolibc](https://github.com/picolibc/picolibc): 面向资源受限嵌入式系统的 C 标准库（融合 Newlib 与 AVR Libc 代码），整体采用 BSD 风格许可。
- [StringLib](https://github.com/CMDred/StringLib): 面向 Minecraft 数据包的字符串工具库，提供 `concat`、`find`、`replace` 等优化的字符串操作，采用 MIT License。
...
- [Datapack Optimization Helper](https://github.com/TheSalts/datapack-optimization-helper)：一个 Minecraft 数据包优化辅助工具，为 `mcfunction` 后处理优化提供了参考，遵循 [MIT License](https://github.com/TheSalts/datapack-optimization-helper/blob/master/LICENSE)。
- [Codex](https://openai.com/codex/)：特别感谢 Codex，它极大地帮助我们在开发过程中进行快速迭代。
