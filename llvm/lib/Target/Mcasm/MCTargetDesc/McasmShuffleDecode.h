//===-- McasmShuffleDecode.h - Mcasm shuffle decode logic -----------*-C++-*---===//
//
...
#ifndef LLVM_LIB_TARGET_Mcasm_UTILS_McasmSHUFFLEDECODE_H
#define LLVM_LIB_TARGET_Mcasm_UTILS_McasmSHUFFLEDECODE_H
