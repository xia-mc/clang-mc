//= McasmIntelInstPrinter.h - Convert Mcasm MCInst to assembly syntax -*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an Mcasm MCInst to Intel style .s file syntax.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINTELINSTPRINTER_H
#define LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINTELINSTPRINTER_H
...
class McasmIntelInstPrinter final : public McasmInstPrinterCommon {
public:
  McasmIntelInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
                      const MCRegisterInfo &MRI)
    : McasmInstPrinterCommon(MAI, MII, MRI) {}
...
#endif // LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINTELINSTPRINTER_H
