//===-- McasmFixupKinds.h - Mcasm Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmFIXUPKINDS_H
#define LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmFIXUPKINDS_H
