...
#ifndef LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmTARGETSTREAMER_H
#define LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmTARGETSTREAMER_H

#include "llvm/MC/MCStreamer.h"

namespace llvm {

/// Mcasm target streamer implementing x86-only assembly directives.
class McasmTargetStreamer : public MCTargetStreamer {
public:
  McasmTargetStreamer(MCStreamer &S) : MCTargetStreamer(S) {}
...
/// Implements Mcasm-only null emission.
inline MCTargetStreamer *createMcasmNullTargetStreamer(MCStreamer &S) {
