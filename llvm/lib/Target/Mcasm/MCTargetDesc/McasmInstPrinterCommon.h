...
#ifndef LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINSTPRINTERCOMMON_H
#define LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINSTPRINTERCOMMON_H
...
class McasmInstPrinterCommon : public MCInstPrinter {
public:
...
#endif // LLVM_LIB_TARGET_Mcasm_MCTARGETDESC_McasmINSTPRINTERCOMMON_H
