//===- McasmInstrFMA3Info.h - Mcasm FMA3 Instruction Information ----*- C++ -*-===//
//
...
// about existing Mcasm FMA3 opcodes, classifying and grouping them.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_Mcasm_UTILS_McasmINSTRFMA3INFO_H
#define LLVM_LIB_TARGET_Mcasm_UTILS_McasmINSTRFMA3INFO_H
...
struct McasmInstrFMA3Group {
  ...
  bool operator<(const McasmInstrFMA3Group &RHS) const {
...
const McasmInstrFMA3Group *getFMA3Group(unsigned Opcode, uint64_t TSFlags);

} // end namespace llvm

#endif // LLVM_LIB_TARGET_Mcasm_UTILS_McasmINSTRFMA3INFO_H
