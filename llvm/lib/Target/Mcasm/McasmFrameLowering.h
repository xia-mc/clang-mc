//===-- McasmTargetFrameLowering.h - Define frame lowering for Mcasm -*- C++ -*-==//
//
...
//===----------------------------------------------------------------------===//
//
// This class implements Mcasm-specific bits of TargetFrameLowering class.
//
//===----------------------------------------------------------------------===//
...
public:
  McasmFrameLowering(const McasmSubtarget &STI, MaybeAlign StackAlignOverride);
