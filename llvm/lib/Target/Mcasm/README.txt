//===---------------------------------------------------------------------===//
// Random ideas for the Mcasm backend.
//===---------------------------------------------------------------------===//
...
The Mcasm backend should fold (branch (or (setcc, setcc))) into multiple 
...
to consolidate the following patterns in McasmInstrMMX.td:
