//===-- McasmRegisterInfo.h - Mcasm Register Information Impl -------*- C++ -*-===//
//
...
private:
  ...
  /// StackPtr - Mcasm physical register used as stack ptr.
  ///
  unsigned StackPtr;

  /// FramePtr - Mcasm physical register used as frame ptr.
  ///
  unsigned FramePtr;

  /// BasePtr - Mcasm physical register used as a base ptr in complex stack
...
public:
  ...
  /// McasmInstrInfo::getSPAdjust relies on it when searching for the
